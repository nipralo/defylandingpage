...
export default function FormLight() {
  return (
    <section className="bg-[#dae0df] hide-cta">
      <Wrapper>
        <div className="max-w-2xl mx-auto">
          <h2 className="font-bold text-center mb-4 text-primary">
            REGISTER YOUR <span className="text-outline-primary">INTEREST</span>
          </h2>
          ...
          >
            {formFields.map((field) => (
              <input
                ...
                className="w-full px-4 py-3 border border-white bg-white rounded-sm focus:outline-none"
                required
              />
            ))}
          ...
          <p className="mt-4 text-accent-green-text italic">
