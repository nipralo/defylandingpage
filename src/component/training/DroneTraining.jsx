  ...
  return (
    <section className="">
      <Wrapper className="overflow-hidden">
        <div className="bg-primary-light rounded-primary">
          <Wrapper>
            {/* Title */}
            <h2 className="text-center text-balance mb-heading">
            ...
            <div className="grid grid-cols-2 content-center max-w-3xl mx-auto">
              {trainingItems.map((item, idx) => (
                <div
                  key={idx}
                  className={`flex flex-col gap-2 lg:gap-4 items-center justify-center text-center my-4 md:my-6 lg:my-10 px-4 ${
                    idx % 2 ? "" : "border-r-2 border-accent-gold/20"
                  }`}
                >
                  <img
                    src={item.icon}
